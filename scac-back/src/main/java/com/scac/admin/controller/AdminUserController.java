...
public class AdminUserController {
        ...
        public ResponseEntity<ApiResponse<List<AdminUserRes>>> getUsers(
                ...
                return ResponseEntity.ok(ApiResponse.success("회원 목록 조회를 완료했습니다.", users));
        }
        ...
        public ResponseEntity<ApiResponse<AdminUserRes>> getUserDetail(
                ...
                return ResponseEntity.ok(ApiResponse.success("회원 상세 조회를 완료했습니다.", userDetail));
        }
        ...
        @AutoLog(logType = "USER", action = "PENALTY", targetType = "USER", content = "관리자에 의한 회원 제재 처리")
        public ResponseEntity<ApiResponse<Void>> applyPenalty(@PathVariable(name = "userId") Long userId,
